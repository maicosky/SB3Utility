...
{
	partial class FormAnimatorDragDrop
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxFrameAppend.Enabled = false;
			...
			this.checkBoxFrameDestinationLock.Location = new System.Drawing.Point(363, 16);
			...
			// numericFrameId
			// 
			this.numericFrameId.Location = new System.Drawing.Point(158, 13);
			...
			this.label1.Text = "Destination Parent Transform";
			// 
			// textBoxFrameName
			// 
			this.textBoxFrameName.Location = new System.Drawing.Point(222, 13);
			...
			// numericMeshId
			// 
			this.numericMeshId.Location = new System.Drawing.Point(125, 9);
			...
			// textBoxMeshName
			// 
			this.textBoxMeshName.Location = new System.Drawing.Point(189, 9);
			this.textBoxMeshName.Name = "textBoxMeshName";
			this.textBoxMeshName.ReadOnly = true;
			this.textBoxMeshName.Size = new System.Drawing.Size(159, 20);
			...
			this.label6.Text = "Destination Transform";
			// 
			// label7
			// 
			...
			this.Text = "Options";
			this.Shown += new System.EventHandler(this.FormAnimatorDragDrop_Shown);
			this.VisibleChanged += new System.EventHandler(this.FormAnimatorDragDrop_VisibleChanged);
			this.Resize += new System.EventHandler(this.FormAnimatorDragDrop_Resize);

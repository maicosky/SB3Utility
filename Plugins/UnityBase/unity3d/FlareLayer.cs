...
{
	class FlareLayer : Component, LinkedByGameObject, StoresReferences
	{
		...
		public FlareLayer(AssetCabinet file) :
			this(file, 0, UnityClassID.FlareLayer, UnityClassID.FlareLayer)
		{

namespace SB3Utility
{
	partial class FormXA
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBoxAnimationEditedTracks = new System.Windows.Forms.ComboBox();
			this.groupBox2 = new System.Windows.Forms.GroupBox();
			this.label20 = new System.Windows.Forms.Label();
			this.editTextBoxAnimationBoneReplacement = new SB3Utility.EditTextBox();
			this.label19 = new System.Windows.Forms.Label();
			this.editTextBoxAnimationBonePattern = new SB3Utility.EditTextBox();
			this.comboBoxAnimationXXLock = new System.Windows.Forms.ComboBox();
			this.buttonAnimationTrackCompare = new System.Windows.Forms.Button();
			...
			this.tabControlAnimationKeyframeMatrix = new System.Windows.Forms.TabControl();
			this.tabPageAnimationKeyframeSRT = new System.Windows.Forms.TabPage();
			this.dataGridViewAnimationKeyframeSRT = new SB3Utility.DataGridViewEditor();
			this.tabPageAnimationKeyframeMatrix = new System.Windows.Forms.TabPage();
			this.dataGridViewAnimationKeyframeMatrix = new SB3Utility.DataGridViewEditor();
			this.tabPageAnimationKeyframeRotQ = new System.Windows.Forms.TabPage();
			this.buttonAnimationKeyframeRotQFlip = new System.Windows.Forms.Button();
			this.buttonAnimationKeyframeRotQInvert = new System.Windows.Forms.Button();
			this.dataGridViewAnimationKeyframeRotQ = new SB3Utility.DataGridViewEditor();
			this.buttonAnimationKeyframeNew = new System.Windows.Forms.Button();
			...
			this.tabControlAnimationKeyframeMatrix.SuspendLayout();
			this.tabPageAnimationKeyframeSRT.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dataGridViewAnimationKeyframeSRT)).BeginInit();
			this.tabPageAnimationKeyframeMatrix.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dataGridViewAnimationKeyframeMatrix)).BeginInit();
			this.tabPageAnimationKeyframeRotQ.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dataGridViewAnimationKeyframeRotQ)).BeginInit();
			...
			this.tabControlXA.Size = new System.Drawing.Size(524, 578);
			...
			this.tabPageXAObjectView.Size = new System.Drawing.Size(516, 552);
			...
			this.splitContainer7.Size = new System.Drawing.Size(516, 552);
			...
			this.treeViewXA.Size = new System.Drawing.Size(227, 552);
			...
			this.tableLayoutXAHex.Size = new System.Drawing.Size(285, 532);
			...
			this.tabPageMaterial.Size = new System.Drawing.Size(516, 552);
			...
			this.tabPageType2.Size = new System.Drawing.Size(516, 552);
			...
			this.tabPageMorph.Size = new System.Drawing.Size(516, 552);
			...
			this.splitContainerMorph.Size = new System.Drawing.Size(510, 546);
			this.splitContainerMorph.SplitterDistance = 419;
        ...
        "unchecked, each morph keyframe will appear as channel in it\'s own BlendShape.");
			...
			this.treeViewMorphClip.Size = new System.Drawing.Size(315, 308);
			...
			this.listViewMorphKeyframe.Size = new System.Drawing.Size(358, 106);
			...
			this.tabPageType4.Size = new System.Drawing.Size(516, 552);
			...
			this.tabPageAnimation.Size = new System.Drawing.Size(516, 552);
			...
			// 
			this.splitContainerAnimation.Panel2.Controls.Add(this.buttonAnimationClipDelete);
			this.splitContainerAnimation.Panel2.Controls.Add(this.dataGridViewAnimationClip);
			this.splitContainerAnimation.Panel2.Controls.Add(this.buttonAnimationClipCopy);
			this.splitContainerAnimation.Panel2.Controls.Add(this.buttonAnimationClipMoveUp);
			this.splitContainerAnimation.Panel2.Controls.Add(this.buttonAnimationClipMoveDown);
			this.splitContainerAnimation.Panel2.Controls.Add(this.label33);
			this.splitContainerAnimation.Size = new System.Drawing.Size(510, 546);
			this.splitContainerAnimation.SplitterDistance = 405;
			this.splitContainerAnimation.TabIndex = 200;
			// 
			// label21
			// 
			this.label21.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.label21.AutoSize = true;
			this.label21.Location = new System.Drawing.Point(360, 236);
			this.label21.Name = "label21";
			this.label21.Size = new System.Drawing.Size(106, 13);
			this.label21.TabIndex = 181;
			this.label21.Text = "Select Edited Tracks";
			// 
			// comboBoxAnimationEditedTracks
			// 
			this.comboBoxAnimationEditedTracks.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.comboBoxAnimationEditedTracks.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBoxAnimationEditedTracks.FormattingEnabled = true;
			this.comboBoxAnimationEditedTracks.Location = new System.Drawing.Point(360, 252);
			this.comboBoxAnimationEditedTracks.Name = "comboBoxAnimationEditedTracks";
			this.comboBoxAnimationEditedTracks.Size = new System.Drawing.Size(150, 21);
			this.comboBoxAnimationEditedTracks.Sorted = true;
			this.comboBoxAnimationEditedTracks.TabIndex = 32;
			this.comboBoxAnimationEditedTracks.SelectedIndexChanged += new System.EventHandler(this.comboBoxAnimationEditedTracks_SelectedIndexChanged);
			// 
			// groupBox2
			// 
			this.groupBox2.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.groupBox2.Controls.Add(this.label20);
			this.groupBox2.Controls.Add(this.editTextBoxAnimationBoneReplacement);
			this.groupBox2.Controls.Add(this.label19);
			this.groupBox2.Controls.Add(this.editTextBoxAnimationBonePattern);
			this.groupBox2.Controls.Add(this.comboBoxAnimationXXLock);
			this.groupBox2.Location = new System.Drawing.Point(360, 92);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(150, 128);
			this.groupBox2.TabIndex = 20;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "XX Lock && Map";
			this.toolTip1.SetToolTip(this.groupBox2, "Also causes exporting of meshes to include only this XA\'s tracks.\r\nUses Regular E" +
        "xpression syntax from both fields.");
			// 
			// label20
			// 
			...
			this.label20.Text = "Bone Replacement";
			// 
			// editTextBoxAnimationBoneReplacement
			// 
			this.editTextBoxAnimationBoneReplacement.Location = new System.Drawing.Point(6, 102);
			this.editTextBoxAnimationBoneReplacement.Name = "editTextBoxAnimationBoneReplacement";
			this.editTextBoxAnimationBoneReplacement.Size = new System.Drawing.Size(139, 20);
			this.editTextBoxAnimationBoneReplacement.TabIndex = 26;
			// 
			// label19
			// 
			...
			this.label19.Text = "Bone Pattern";
			// 
			// editTextBoxAnimationBonePattern
			// 
			this.editTextBoxAnimationBonePattern.Location = new System.Drawing.Point(6, 62);
			this.editTextBoxAnimationBonePattern.Name = "editTextBoxAnimationBonePattern";
			this.editTextBoxAnimationBonePattern.Size = new System.Drawing.Size(139, 20);
			this.editTextBoxAnimationBonePattern.TabIndex = 24;
			this.editTextBoxAnimationBonePattern.AfterEditTextChanged += new System.EventHandler(this.editTextBoxAnimationBoneExtension_AfterEditTextChanged);
			// 
			// comboBoxAnimationXXLock
			// 
			this.comboBoxAnimationXXLock.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBoxAnimationXXLock.FormattingEnabled = true;
			this.comboBoxAnimationXXLock.Location = new System.Drawing.Point(6, 19);
			this.comboBoxAnimationXXLock.Name = "comboBoxAnimationXXLock";
			this.comboBoxAnimationXXLock.Size = new System.Drawing.Size(139, 21);
			this.comboBoxAnimationXXLock.TabIndex = 22;
			this.comboBoxAnimationXXLock.SelectedIndexChanged += new System.EventHandler(this.comboBoxAnimationXXLock_SelectedIndexChanged);
			// 
			...
			this.listViewAnimationTrack.Size = new System.Drawing.Size(354, 261);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.groupBox1.Controls.Add(this.buttonAnimationKeyframeRemove);
			this.groupBox1.Controls.Add(this.tabControlAnimationKeyframeMatrix);
			this.groupBox1.Controls.Add(this.buttonAnimationKeyframeNew);
			...
			this.groupBox1.Text = "Keyframe";
			// 
			// buttonAnimationKeyframeRemove
			// 
			this.buttonAnimationKeyframeRemove.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.buttonAnimationKeyframeRemove.Location = new System.Drawing.Point(155, 44);
			this.buttonAnimationKeyframeRemove.Name = "buttonAnimationKeyframeRemove";
			this.buttonAnimationKeyframeRemove.Size = new System.Drawing.Size(75, 23);
			this.buttonAnimationKeyframeRemove.TabIndex = 114;
			this.buttonAnimationKeyframeRemove.Text = "Remove";
			this.buttonAnimationKeyframeRemove.UseVisualStyleBackColor = true;
			this.buttonAnimationKeyframeRemove.Click += new System.EventHandler(this.buttonAnimationKeyframeRemove_Click);
			// 
			// tabControlAnimationKeyframeMatrix
			// 
			this.tabControlAnimationKeyframeMatrix.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.tabControlAnimationKeyframeMatrix.Controls.Add(this.tabPageAnimationKeyframeSRT);
			this.tabControlAnimationKeyframeMatrix.Controls.Add(this.tabPageAnimationKeyframeMatrix);
			this.tabControlAnimationKeyframeMatrix.Controls.Add(this.tabPageAnimationKeyframeRotQ);
			this.tabControlAnimationKeyframeMatrix.Location = new System.Drawing.Point(252, 10);
			this.tabControlAnimationKeyframeMatrix.Name = "tabControlAnimationKeyframeMatrix";
			this.tabControlAnimationKeyframeMatrix.SelectedIndex = 0;
			this.tabControlAnimationKeyframeMatrix.Size = new System.Drawing.Size(253, 112);
			this.tabControlAnimationKeyframeMatrix.TabIndex = 130;
			this.toolTip1.SetToolTip(this.tabControlAnimationKeyframeMatrix, "Hold down the mouse button on an SRT input field\r\nto change the value with mouse " +
        "movements.");
			// 
			// tabPageAnimationKeyframeSRT
			// 
			this.tabPageAnimationKeyframeSRT.Controls.Add(this.dataGridViewAnimationKeyframeSRT);
			this.tabPageAnimationKeyframeSRT.Location = new System.Drawing.Point(4, 22);
			this.tabPageAnimationKeyframeSRT.Name = "tabPageAnimationKeyframeSRT";
			this.tabPageAnimationKeyframeSRT.Padding = new System.Windows.Forms.Padding(3);
			this.tabPageAnimationKeyframeSRT.Size = new System.Drawing.Size(245, 86);
			this.tabPageAnimationKeyframeSRT.TabIndex = 1;
			this.tabPageAnimationKeyframeSRT.Text = "SRT";
			this.tabPageAnimationKeyframeSRT.UseVisualStyleBackColor = true;
			// 
			// dataGridViewAnimationKeyframeSRT
			// 
			this.dataGridViewAnimationKeyframeSRT.AllowUserToAddRows = false;
			this.dataGridViewAnimationKeyframeSRT.AllowUserToDeleteRows = false;
			this.dataGridViewAnimationKeyframeSRT.AllowUserToResizeColumns = false;
			this.dataGridViewAnimationKeyframeSRT.AllowUserToResizeRows = false;
			this.dataGridViewAnimationKeyframeSRT.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
			this.dataGridViewAnimationKeyframeSRT.AutoSizeRowsMode = System.Windows.Forms.DataGridViewAutoSizeRowsMode.AllCells;
			this.dataGridViewAnimationKeyframeSRT.ClipboardCopyMode = System.Windows.Forms.DataGridViewClipboardCopyMode.Disable;
			this.dataGridViewAnimationKeyframeSRT.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.Single;
			this.dataGridViewAnimationKeyframeSRT.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dataGridViewAnimationKeyframeSRT.Dock = System.Windows.Forms.DockStyle.Fill;
			this.dataGridViewAnimationKeyframeSRT.Location = new System.Drawing.Point(3, 3);
			this.dataGridViewAnimationKeyframeSRT.MultiSelect = false;
			this.dataGridViewAnimationKeyframeSRT.Name = "dataGridViewAnimationKeyframeSRT";
			this.dataGridViewAnimationKeyframeSRT.RowHeadersVisible = false;
			this.dataGridViewAnimationKeyframeSRT.ScrollBars = System.Windows.Forms.ScrollBars.None;
			this.dataGridViewAnimationKeyframeSRT.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.CellSelect;
			this.dataGridViewAnimationKeyframeSRT.ShowRowIndex = false;
			this.dataGridViewAnimationKeyframeSRT.Size = new System.Drawing.Size(239, 80);
			this.dataGridViewAnimationKeyframeSRT.TabIndex = 132;
			this.dataGridViewAnimationKeyframeSRT.TabStop = false;
			this.dataGridViewAnimationKeyframeSRT.CellValueChanged += new System.Windows.Forms.DataGridViewCellEventHandler(this.dataGridViewAnimationKeyframeSRT_CellValueChanged);
			this.dataGridViewAnimationKeyframeSRT.SelectionChanged += new System.EventHandler(this.dataGridViewAnimationKeyframeSRT_SelectionChanged);
			this.dataGridViewAnimationKeyframeSRT.KeyDown += new System.Windows.Forms.KeyEventHandler(this.dataGridViewAnimationKeyframeSRT_KeyDown);
			this.dataGridViewAnimationKeyframeSRT.MouseCaptureChanged += new System.EventHandler(this.dataGridViewAnimationKeyframeSRT_MouseCaptureChanged);
			this.dataGridViewAnimationKeyframeSRT.MouseDown += new System.Windows.Forms.MouseEventHandler(this.dataGridViewAnimationKeyframeSRT_MouseDown);
			// 
			// tabPageAnimationKeyframeMatrix
			// 
			this.tabPageAnimationKeyframeMatrix.Controls.Add(this.dataGridViewAnimationKeyframeMatrix);
			this.tabPageAnimationKeyframeMatrix.Location = new System.Drawing.Point(4, 22);
			this.tabPageAnimationKeyframeMatrix.Name = "tabPageAnimationKeyframeMatrix";
			this.tabPageAnimationKeyframeMatrix.Padding = new System.Windows.Forms.Padding(3);
			this.tabPageAnimationKeyframeMatrix.Size = new System.Drawing.Size(245, 86);
			this.tabPageAnimationKeyframeMatrix.TabIndex = 0;
			this.tabPageAnimationKeyframeMatrix.Text = "Matrix";
			this.tabPageAnimationKeyframeMatrix.UseVisualStyleBackColor = true;
			// 
			// dataGridViewAnimationKeyframeMatrix
			// 
			this.dataGridViewAnimationKeyframeMatrix.AllowUserToAddRows = false;
			this.dataGridViewAnimationKeyframeMatrix.AllowUserToDeleteRows = false;
			this.dataGridViewAnimationKeyframeMatrix.AllowUserToResizeColumns = false;
			this.dataGridViewAnimationKeyframeMatrix.AllowUserToResizeRows = false;
			this.dataGridViewAnimationKeyframeMatrix.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
			this.dataGridViewAnimationKeyframeMatrix.AutoSizeRowsMode = System.Windows.Forms.DataGridViewAutoSizeRowsMode.AllCells;
			this.dataGridViewAnimationKeyframeMatrix.ClipboardCopyMode = System.Windows.Forms.DataGridViewClipboardCopyMode.Disable;
			this.dataGridViewAnimationKeyframeMatrix.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.Single;
			this.dataGridViewAnimationKeyframeMatrix.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dataGridViewAnimationKeyframeMatrix.ColumnHeadersVisible = false;
			this.dataGridViewAnimationKeyframeMatrix.Dock = System.Windows.Forms.DockStyle.Fill;
			this.dataGridViewAnimationKeyframeMatrix.Location = new System.Drawing.Point(3, 3);
			this.dataGridViewAnimationKeyframeMatrix.MultiSelect = false;
			this.dataGridViewAnimationKeyframeMatrix.Name = "dataGridViewAnimationKeyframeMatrix";
			this.dataGridViewAnimationKeyframeMatrix.RowHeadersVisible = false;
			this.dataGridViewAnimationKeyframeMatrix.ScrollBars = System.Windows.Forms.ScrollBars.None;
			this.dataGridViewAnimationKeyframeMatrix.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.CellSelect;
			this.dataGridViewAnimationKeyframeMatrix.ShowRowIndex = false;
			this.dataGridViewAnimationKeyframeMatrix.Size = new System.Drawing.Size(239, 80);
			this.dataGridViewAnimationKeyframeMatrix.TabIndex = 134;
			this.dataGridViewAnimationKeyframeMatrix.TabStop = false;
			this.dataGridViewAnimationKeyframeMatrix.CellValueChanged += new System.Windows.Forms.DataGridViewCellEventHandler(this.dataGridViewAnimationKeyframeMatrix_CellValueChanged);
			// 
			// tabPageAnimationKeyframeRotQ
			// 
			this.tabPageAnimationKeyframeRotQ.Controls.Add(this.buttonAnimationKeyframeRotQFlip);
			this.tabPageAnimationKeyframeRotQ.Controls.Add(this.buttonAnimationKeyframeRotQInvert);
			this.tabPageAnimationKeyframeRotQ.Controls.Add(this.dataGridViewAnimationKeyframeRotQ);
			this.tabPageAnimationKeyframeRotQ.Location = new System.Drawing.Point(4, 22);
			this.tabPageAnimationKeyframeRotQ.Name = "tabPageAnimationKeyframeRotQ";
			this.tabPageAnimationKeyframeRotQ.Size = new System.Drawing.Size(245, 86);
			this.tabPageAnimationKeyframeRotQ.TabIndex = 2;
			this.tabPageAnimationKeyframeRotQ.Text = "RotationQ";
			this.tabPageAnimationKeyframeRotQ.UseVisualStyleBackColor = true;
			// 
			// buttonAnimationKeyframeRotQFlip
			// 
			this.buttonAnimationKeyframeRotQFlip.Location = new System.Drawing.Point(86, 44);
			this.buttonAnimationKeyframeRotQFlip.Name = "buttonAnimationKeyframeRotQFlip";
			this.buttonAnimationKeyframeRotQFlip.Size = new System.Drawing.Size(75, 23);
			this.buttonAnimationKeyframeRotQFlip.TabIndex = 139;
			this.buttonAnimationKeyframeRotQFlip.Text = "Flip";
			this.buttonAnimationKeyframeRotQFlip.UseVisualStyleBackColor = true;
			this.buttonAnimationKeyframeRotQFlip.Click += new System.EventHandler(this.buttonAnimationKeyframeRotQFlip_Click);
			// 
			// buttonAnimationKeyframeRotQInvert
			// 
			this.buttonAnimationKeyframeRotQInvert.Location = new System.Drawing.Point(3, 44);
			this.buttonAnimationKeyframeRotQInvert.Name = "buttonAnimationKeyframeRotQInvert";
			this.buttonAnimationKeyframeRotQInvert.Size = new System.Drawing.Size(75, 23);
			this.buttonAnimationKeyframeRotQInvert.TabIndex = 138;
			this.buttonAnimationKeyframeRotQInvert.Text = "Invert";
			this.buttonAnimationKeyframeRotQInvert.UseVisualStyleBackColor = true;
			this.buttonAnimationKeyframeRotQInvert.Click += new System.EventHandler(this.buttonAnimationKeyframeRotQInvert_Click);
			// 
			// dataGridViewAnimationKeyframeRotQ
			// 
			this.dataGridViewAnimationKeyframeRotQ.AllowUserToAddRows = false;
			this.dataGridViewAnimationKeyframeRotQ.AllowUserToDeleteRows = false;
			this.dataGridViewAnimationKeyframeRotQ.AllowUserToResizeColumns = false;
			this.dataGridViewAnimationKeyframeRotQ.AllowUserToResizeRows = false;
			this.dataGridViewAnimationKeyframeRotQ.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
			this.dataGridViewAnimationKeyframeRotQ.AutoSizeRowsMode = System.Windows.Forms.DataGridViewAutoSizeRowsMode.AllCells;
			this.dataGridViewAnimationKeyframeRotQ.ClipboardCopyMode = System.Windows.Forms.DataGridViewClipboardCopyMode.Disable;
			this.dataGridViewAnimationKeyframeRotQ.ColumnHeadersBorderStyle = System.Windows.Forms.DataGridViewHeaderBorderStyle.Single;
			this.dataGridViewAnimationKeyframeRotQ.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dataGridViewAnimationKeyframeRotQ.Dock = System.Windows.Forms.DockStyle.Top;
			this.dataGridViewAnimationKeyframeRotQ.Location = new System.Drawing.Point(0, 0);
			this.dataGridViewAnimationKeyframeRotQ.MultiSelect = false;
			this.dataGridViewAnimationKeyframeRotQ.Name = "dataGridViewAnimationKeyframeRotQ";
			this.dataGridViewAnimationKeyframeRotQ.RowHeadersVisible = false;
			this.dataGridViewAnimationKeyframeRotQ.ScrollBars = System.Windows.Forms.ScrollBars.None;
			this.dataGridViewAnimationKeyframeRotQ.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.CellSelect;
			this.dataGridViewAnimationKeyframeRotQ.ShowRowIndex = false;
			this.dataGridViewAnimationKeyframeRotQ.Size = new System.Drawing.Size(245, 38);
			this.dataGridViewAnimationKeyframeRotQ.TabIndex = 136;
			this.dataGridViewAnimationKeyframeRotQ.TabStop = false;
			this.dataGridViewAnimationKeyframeRotQ.CellValueChanged += new System.Windows.Forms.DataGridViewCellEventHandler(this.dataGridViewAnimationKeyframeRotQ_CellValueChanged);
			// 
			// buttonAnimationKeyframeNew
			// 
			this.buttonAnimationKeyframeNew.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
			this.buttonAnimationKeyframeNew.Location = new System.Drawing.Point(155, 15);
			this.buttonAnimationKeyframeNew.Name = "buttonAnimationKeyframeNew";
			this.buttonAnimationKeyframeNew.Size = new System.Drawing.Size(75, 23);
			this.buttonAnimationKeyframeNew.TabIndex = 110;
			this.buttonAnimationKeyframeNew.Text = "New";
			this.buttonAnimationKeyframeNew.UseVisualStyleBackColor = true;
			this.buttonAnimationKeyframeNew.Click += new System.EventHandler(this.buttonAnimationKeyframeNew_Click);
			// 
			...
			this.checkBoxAnimationKeyframeSyncPlay.Location = new System.Drawing.Point(7, 49);
			...
			this.checkBoxAnimationKeyframeSyncPlay.TabIndex = 112;
			...
			this.checkBoxAnimationKeyframeSyncPlay.CheckedChanged += new System.EventHandler(this.checkBoxAnimationKeyframeSyncPlay_CheckedChanged);
			// 
			...
			this.buttonAnimationClipPlayPause.Location = new System.Drawing.Point(7, 72);
			...
			this.buttonAnimationClipPlayPause.TabIndex = 116;
			...
			this.trackBarAnimationClipKeyframe.Location = new System.Drawing.Point(33, 74);
			this.trackBarAnimationClipKeyframe.Name = "trackBarAnimationClipKeyframe";
			this.trackBarAnimationClipKeyframe.Size = new System.Drawing.Size(118, 18);
			this.trackBarAnimationClipKeyframe.TabIndex = 118;
			...
			// 
			this.checkBoxAnimationClipLoadNextClip.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			...
			this.checkBoxAnimationClipLoadNextClip.Location = new System.Drawing.Point(9, 102);
			...
			this.checkBoxAnimationClipLoadNextClip.TabIndex = 122;
            ...
            0,
            65536});
			this.numericAnimationClipSpeed.Location = new System.Drawing.Point(155, 99);
			...
			this.numericAnimationClipSpeed.TabIndex = 124;
			...
			this.numericAnimationClipKeyframe.Location = new System.Drawing.Point(155, 73);
			...
			this.numericAnimationClipKeyframe.TabIndex = 120;
			...
			this.labelSkeletalRender.Location = new System.Drawing.Point(211, 77);
			...
			this.label30.Location = new System.Drawing.Point(210, 103);
			...
			// 
			this.buttonAnimationClipDelete.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.buttonAnimationClipDelete.Location = new System.Drawing.Point(409, 110);
			this.buttonAnimationClipDelete.Name = "buttonAnimationClipDelete";
			this.buttonAnimationClipDelete.Size = new System.Drawing.Size(100, 23);
			this.buttonAnimationClipDelete.TabIndex = 218;
			...
			this.dataGridViewAnimationClip.Size = new System.Drawing.Size(403, 115);
			this.dataGridViewAnimationClip.StandardTab = true;
			this.dataGridViewAnimationClip.TabIndex = 210;
			...
			this.ColumnAnimationClipName.Width = 134;
			// 
			...
			// 
			this.buttonAnimationClipCopy.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.buttonAnimationClipCopy.Location = new System.Drawing.Point(409, 81);
			this.buttonAnimationClipCopy.Name = "buttonAnimationClipCopy";
			this.buttonAnimationClipCopy.Size = new System.Drawing.Size(100, 23);
			this.buttonAnimationClipCopy.TabIndex = 216;
			...
			// 
			this.buttonAnimationClipMoveUp.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.buttonAnimationClipMoveUp.Location = new System.Drawing.Point(409, 21);
			this.buttonAnimationClipMoveUp.Name = "buttonAnimationClipMoveUp";
			this.buttonAnimationClipMoveUp.Size = new System.Drawing.Size(100, 23);
			this.buttonAnimationClipMoveUp.TabIndex = 212;
			...
			// 
			this.buttonAnimationClipMoveDown.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.buttonAnimationClipMoveDown.Location = new System.Drawing.Point(409, 50);
			this.buttonAnimationClipMoveDown.Name = "buttonAnimationClipMoveDown";
			this.buttonAnimationClipMoveDown.Size = new System.Drawing.Size(100, 23);
			this.buttonAnimationClipMoveDown.TabIndex = 214;
			...
			this.tabControlAnimationKeyframeMatrix.ResumeLayout(false);
			this.tabPageAnimationKeyframeSRT.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dataGridViewAnimationKeyframeSRT)).EndInit();
			this.tabPageAnimationKeyframeMatrix.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dataGridViewAnimationKeyframeMatrix)).EndInit();
			this.tabPageAnimationKeyframeRotQ.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.dataGridViewAnimationKeyframeRotQ)).EndInit();
		...
		private System.Windows.Forms.TabControl tabControlAnimationKeyframeMatrix;
		private System.Windows.Forms.TabPage tabPageAnimationKeyframeSRT;
		private DataGridViewEditor dataGridViewAnimationKeyframeSRT;
		private System.Windows.Forms.TabPage tabPageAnimationKeyframeMatrix;
		private DataGridViewEditor dataGridViewAnimationKeyframeMatrix;
		private System.Windows.Forms.Button buttonAnimationKeyframeRemove;
		private System.Windows.Forms.Button buttonAnimationKeyframeNew;
		...
		private System.Windows.Forms.Button buttonAnimationTrackCompare;
		private System.Windows.Forms.TabPage tabPageAnimationKeyframeRotQ;
		private DataGridViewEditor dataGridViewAnimationKeyframeRotQ;
		private System.Windows.Forms.Button buttonAnimationKeyframeRotQInvert;
		private System.Windows.Forms.GroupBox groupBox2;
		private System.Windows.Forms.Label label19;
		private EditTextBox editTextBoxAnimationBonePattern;
		private System.Windows.Forms.Label label20;
		private EditTextBox editTextBoxAnimationBoneReplacement;
		public System.Windows.Forms.ComboBox comboBoxAnimationXXLock;
